  ...
  return (
    <div className="form-group">
      <span className="col-sm-12">
        <TextTip color="blue">
          {t('You can use the URL of a git repository.')}
        </TextTip>
      </span>
        ...
        >
          <span className="flex">
            <Input
              ...
              placeholder={t('https://github.com/portainer/portainer-compose')}
...
export function useUrlValidation(force: boolean) {
  ...
  return (string() as StringSchema<string, GitFormModel>)
    ...
    .test(
      i18next.t('repo-exists'),
      i18next.t('Repository does not exist'),
      existenceTest
    );
}
