        ...
        <Alert color="warn" className="col-sm-12 mb-2">
          <div
            dangerouslySetInnerHTML={{
              __html: t(
                'Only do this <b>once</b> for your environment, regardless of how many nodes are in the cluster. You do <b>not</b> need to add each node as an individual environment in Portainer. Adding just one node (we recommend the manager node) will allow Portainer to manage the entire cluster.'
              ),
            }}
          />
        </Alert>
