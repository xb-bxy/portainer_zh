    ...
    <>
      ...
      <div className="row">
        <div className="col-sm-12">
          <Widget>
            <WidgetTitle title={t('Environment Wizard')} icon={Wand2} />
            <WidgetBody>
              <div className="row">
                <div className="col-sm-12 form-section-title">
                  {t('Welcome to Portainer')}
                </div>
                <div className="text-muted small">
                  {localEnvironmentAdded.status === 'success' && (
                    <p>
                      {t('homeView.localEnvironmentConnected', {
                  ...
                  {localEnvironmentAdded.status === 'error' && (
                    <p>
                      ...
                      <br />
                      {t(
                        'Please ensure your environment is correctly exposed. For help with installation visit'
                      )}{' '}
                      <a
                  ...
                  <p>
                    {t(
                      'Get started below with your local portainer or connect more Zcontainer environments.'
                    )}
                  </p>
                </div>
