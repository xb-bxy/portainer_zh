  ...
  return (
    <Card className="pb-5">
      <div className="flex flex-col gap-6">
        <TextTip color="blue">
          {t('Allow access to traffic')} <b>{t('external')}</b>{' '}
          {t('to the cluster via a')} <b>{t('LoadBalancer service')}</b>.{' '}
          {t(
            'If running on a cloud platform, this auto provisions a cloud load balancer.'
          )}
        </TextTip>
