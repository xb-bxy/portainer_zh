...
angular.module('portainer.docker').controller('LogViewerController', [
  ...
  'FileSaver',
  '$translate',
  function ($scope, clipboard, Blob, FileSaver, $translate) {
    this.state = {
      availableSinceDatetime: [
        { desc: $translate.instant('Last day'), value: moment().subtract(1, 'days').format() },
        { desc: $translate.instant('Last 4 hours'), value: moment().subtract(4, 'hours').format() },
        { desc: $translate.instant('Last hour'), value: moment().subtract(1, 'hours').format() },
        { desc: $translate.instant('Last 10 minutes'), value: moment().subtract(10, 'minutes').format() },
      ],
