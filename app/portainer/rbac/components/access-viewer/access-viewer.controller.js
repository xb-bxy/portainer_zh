...
export default class AccessViewerController {
  /* @ngInject */
  constructor($scope, Notifications, RoleService, UserService, GroupService, TeamService, TeamMembershipService, Authentication, $translate) {
    this.$scope = $scope;
    ...
    this.$translate = $translate; // 注入 $translate 服务
