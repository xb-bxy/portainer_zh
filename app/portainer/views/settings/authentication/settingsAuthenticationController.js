...
function SettingsAuthenticationController($q, $scope, $state, Notifications, SettingsService, FileUploadService, TeamService, LDAPService, $translate) {
  $scope.authMethod = 1;
  ...
  $scope.state = {
    ...
    availableUserSessionTimeoutOptions: [
      {
        key: $translate.instant('1 hour'),
        value: '1h',
      },
      {
        key: $translate.instant('4 hours'),
        value: '4h',
      },
      {
        key: $translate.instant('8 hours'),
        value: '8h',
      },
      {
        key: $translate.instant('24 hours'),
        value: '24h',
      },
      { key: $translate.instant('1 week'), value: `${24 * 7}h` },
      { key: $translate.instant('1 month'), value: `${24 * 30}h` },
      { key: $translate.instant('6 months'), value: `${24 * 30 * 6}h` },
      { key: $translate.instant('1 year'), value: `${24 * 30 * 12}h` },
    ],
  };
